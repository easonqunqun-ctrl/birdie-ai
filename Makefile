...
ai-engine-test-rotation:
	cd ai_engine && uv run pytest tests/test_rotation_track.py tests/test_rotation_regression.py tests/test_rotation_regression_real.py tests/test_rotation_repeatability.py tests/test_rotation_regression_v1_path.py tests/test_rotation_issue_copy.py tests/test_nelly_dtl_scoring.py tests/test_diagnose.py tests/test_diagnose_v2_measurability.py tests/test_pose_refine.py -v --tb=short
