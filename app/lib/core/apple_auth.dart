...
///
/// 组织账号 Team `H5ZY5QNKRW`（与向野而生同公司）+ App ID `cn.birdieai.birdieApp`
/// 勾选 Sign in with Apple；`Runner.entitlements` 已含对应能力。
/// 联调仍可用 `--dart-define=MOCK_LOGIN=true --dart-define=APPLE_MOCK_TOKEN=…`。
class AppleAuth {
  AppleAuth._();
