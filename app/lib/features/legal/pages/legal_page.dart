        ...
        children: [
          ...
          Text(
            kind == LegalKind.terms
                ? '欢迎使用「领翼golf」相关产品与服务。「领翼golf」由北京思无界控股有限公司（下称「本公司」「我们」或「运营方」）运营。请您在注册登录或使用本产品前认真阅读本协议。本产品中的《隐私政策》构成本协议组成部分。'
                : '「领翼golf」App 及产品服务由北京思无界控股有限公司（下称「我们」或「本公司」）提供。请您在使用本产品前仔细阅读本政策，了解我们如何收集、使用、存储、共享和保护您的个人信息。',
            style: TextStyle(
                fontSize: rpx(28),
                height: 1.6,
          ...
          Text(
            kind == LegalKind.terms
                ? '本协议解释权在法律允许范围内由北京思无界控股有限公司享有。如对条款有疑问，请以本页所载版本与日期的文本为准：$_legalMetaDate。'
...
const _termsSections = <_Section>[
  ...
  _Section('二、账号与实名制', [
    '· iOS 版本当前主要以 Sign in with Apple 完成账号创建与校验；其他平台可能提供微信等登录方式。您同意遵守相应平台规则及服务条款。',
    '· 您对使用您账号身份在本产品内进行的一切操作行为负责；如因账号保管不善导致第三人使用而造成的损失，由您先行承担。',
  ...
  _Section('六、会员、付费与发票', [
    '本版本 iOS App 内暂不提供付费会员购买；您可使用免费额度。若后续开通付费会员，iOS 将通过苹果 App 内购买（In-App Purchase）完成，资费与周期以产品内展示及苹果订单为准；其他平台支付方式以当时说明为准。发票与争议处理遵照相应支付平台规则与国家监管要求。',
  ]),
...
const _privacySections = <_Section>[
  _Section('一、我们收集的信息', [
    '· 账号信息：Sign in with Apple 返回的稳定标识（Apple sub）及可选邮箱/姓名；若后续开放微信登录，则含微信 OpenID 等标识；您主动填写的昵称、头像、球龄与水平等。',
    ...
    '· 付费与履约信息：若使用 App 内购买，含订单与履约状态等最少交易信息。',
  ]),
  _Section('二、我们如何使用这些信息', [
    '用于提供与维护产品、改进与安全、履行法定义务。在您未另行单独同意的前提下，我们不会将您的个人视频或可识别身份的内容用于与提供本产品服务无关的模型训练。',
  ]),
  _Section('三、对外提供与委托处理（含第三方 AI）', [
    '为实现 AI 教练等文字能力，我们可能将您主动输入的对话文本及必要上下文，经加密传输发送至国内大模型服务商进行处理，当前主要使用 DeepSeek（深度求索）等合规服务；挥杆视频首先上传至本公司云端完成分析。',
    '我们还会与云存储、安全与风控等基础设施合作方委托处理必要信息。不会向第三方出售个人信息。',
    '首次使用相关功能前，App 内会弹窗说明发送的数据类型与接收方，并征得您的明示同意。',
  ]),
