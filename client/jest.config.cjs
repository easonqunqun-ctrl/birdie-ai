...
module.exports = {
  ...
  coverageThreshold: {
    ...
    './src/constants/scoreLevel.ts':     { branches: 95, functions: 100, lines: 95, statements: 95 },
    './src/constants/qualityWarnings.ts': { branches: 95, functions: 100, lines: 95, statements: 95 },
    './src/constants/golf.ts':           { branches: 100, functions: 100, lines: 100, statements: 100 },
    './src/utils/deferNavigation.ts':  { branches: 100, functions: 100, lines: 100, statements: 100 },
    './src/components/EnvBadge.tsx':   { branches: 70, functions: 100, lines: 95, statements: 95 },
  },
  clearMocks: true,
  restoreMocks: true,
  testTimeout: 10000,
