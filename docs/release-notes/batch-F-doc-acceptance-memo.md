...
| **par-C2** 会员到期/降级 | **工程 ☑** · 产品签字栏待填 |
| **par-C3** 示例视频 §3.6 | **工程 ☑** · 产品签字栏待填 |
| **`docs/01` 勾选同步** | O-11 / O-12 / P-04 → `[x]`；P-03 / DOC-02 / O-14 → `[~]` 更新脚注 |
| **DOC-05 巡检** | 本节即发版前脚注↔主行对齐；无新增「脚注已实现、主行仍 `- [ ]`」项 |

**整体判定**：**文档债已清至工程验收水位**；正式发版前仅需产品在 par-C2/C3 纪要签字栏填姓名。
...
| [par-C2](./par-C2-membership-expiry-acceptance-memo.md) | ☑ 2026-05-21 | ▢ 待填 |
| [par-C3](./par-C3-sample-video-acceptance-memo.md) | ☑ 2026-05-21 | ▢ 待填 |
