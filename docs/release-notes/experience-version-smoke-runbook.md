...
## 当前线上基线（2026-07-18 · 开发中 1.2.36 · 线上体验版仍为 1.2.35）

| 项 | 值 |
|----|-----|
| **小程序版本** | **1.2.36**（本轮 Batch-J 产品优先级；待 `make client-build-weapp-prod` 上传） |
| **线上体验版** | **1.2.35**（公测免费已上传；真机 P0 仍待勾） |
| **Git / CVM** | API `https://api.birdieai.cn/v1` · `promo_free` 已生效 · 健康预检见 [`pp-j0-preflight-2026-07-18.md`](./pp-j0-preflight-2026-07-18.md) |
| **本版变更（1.2.36）** | PP-05/06/07/09/10：漏斗埋点 · 公测价值卡 · 本周主攻 · 练完再拍 · 对比晒进步 |
| **当前任务** | ① 真机勾 **1.2.35 P0**（或升 1.2.36 后一并勾）② Phase2 §D ③ 上传 **1.2.36** |

**下一步**：构建上传 **1.2.36** → mp 选为体验版 → 真机验收（含下方 Batch-J 增量项）。

### Batch-J 增量（1.2.36 · 约 10 分钟）

- [ ] 报告页见 **「本周主攻」** 卡片 +「去练这个动作」
- [ ] 公测期报告页见 **价值感知卡**（每日最多一次）→ 进会员中心
- [ ] 训练打卡成功 → 弹窗「去拍摄 / 稍后再说」
- [ ] 历史对比页见 **晒进步** 卡 + 分享 / 海报入口
- [ ] API 健康预检：[`pp-j0-preflight-2026-07-18.md`](./pp-j0-preflight-2026-07-18.md) ✅ 2026-07-18
