...
## 当前线上基线（2026-07-21 · 1.2.42 待上传 · 待选为体验版 / 提审）


| 项                | 值                                                                                                                         |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------- |
| **小程序版本**        | **1.2.42**（版本已 bump；发版流程中上传开发版本）                                                          |
| **Git / CVM**    | API `https://api.birdieai.cn/v1` · 后端无业务变更（可选 release-cvm 对齐）                                              |
| **本版变更（1.2.42）** | ① 协议合规：登录「我已阅读并同意」+ 未勾选禁用；首启同意页默认未勾选 ② adapters（kv/share/safeArea）与浮层定位收敛 ③ 拍摄校验走 `validatePickedVideo`；训练空态修复见 1.2.41 |
| **当前任务**         | ① 上传开发版 **1.2.42** ② mp **选为体验版**或**提交审核**（仅人工） ③ 真机确认版本号 + 协议勾选 + 训练空态                                                                 |
