...
## 当前线上基线（2026-06-04 · 1.2.35 待发体验版）

| 项 | 值 |
|----|-----|
| **小程序版本** | **1.2.35**（公测免费至 7/30；待上传体验版 / 正式版） |
| **Git / CVM** | 待发版 commit · API `https://api.birdieai.cn/v1` |
| **本版变更** | **PROMO_FREE_UNTIL=2026-07-30** 全员不限次 + 历史 paywall 关闭；首页/会员页公测 banner |
| **当前任务** | 上传体验版 → 真机 smoke → 可选提审正式版 |

**下一步**：开发者工具上传 `client/dist` → mp 后台选体验版 → 勾下方 **「1.2.35 公测免费 P0」**。
