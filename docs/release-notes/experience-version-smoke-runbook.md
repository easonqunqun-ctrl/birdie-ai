...
## 当前线上基线（2026-07-18 · 1.2.36 已上传 · 待选为体验版）

| 项 | 值 |
|----|-----|
| **小程序版本** | **1.2.36**（CLI 已上传，包约 1.3 MB；**待**公众平台 **选为体验版**） |
...
| **当前任务** | ① mp **选为体验版** ② 真机勾 **Batch-J 增量 + 公测 P0 + §D** |

**下一步（仅人工）**：微信公众平台 → 版本管理 → 开发版本 **1.2.36** → **选为体验版** → 真机 smoke（关于页确认版本号）。
